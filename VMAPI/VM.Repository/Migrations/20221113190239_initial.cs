    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoffeeToIngredient", x => new { x.CoffeeId, x.IngredientId });
                    table.ForeignKey(
                        name: "FK_CoffeeToIngredient_Coffees_CoffeeId",
                        column: x => x.CoffeeId,
                        principalTable: "Coffees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoffeeToIngredient_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderToIngredient", x => new { x.OrderId, x.IngredientId });
                    table.ForeignKey(
                        name: "FK_OrderToIngredient_Ingredients_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderToIngredient_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoffeeToIngredient_IngredientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderToIngredient_IngredientId",
